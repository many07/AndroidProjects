...
public class BlueFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.boton_fragment_blue).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mListener.onBlueFragmentButtonClicked();
            }
        });
        TextView blueTextView = view.findViewById(R.id.text_view_fragment_blue);
        blueTextView.setText(mParam1+ " / "+ mParam2);
        return view;
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onBlueFragmentButtonClicked();
    }
}
