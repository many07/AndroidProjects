...
public class RedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.boton_fragment_red).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mListener.onRedFragmentInteractionClicked();
            }
        });
        TextView textView = (TextView) view.findViewById(R.id.text_view_fragment_red);
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onRedFragmentInteractionClicked();
    }
}
